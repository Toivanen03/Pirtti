...
const ApplicationModal = ({ application, setApplication, handler, handleSubmit, handleMarkRead, mobile, portrait }) => {
...
<div style={{ pageBreakAfter: 'always', textAlign: 'center', margin: '1em 0' }} />
                ...
                {handleSubmit &&
                    <Row className='mt-5 mb-2 text-center'>
                        <Col className={portrait ? 'col-2 offset-4' : 'col-1 offset-5'}>
