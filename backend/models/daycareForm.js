...
const daycareSchema = new mongoose.Schema({
    ...
    tarve: { type: String, required: true },
    paivat: { type: String, required: true },
    alkamispaiva: { type: String, required: true },
    alkamisaika: { type: String, required: true },
    paattymisaika: { type: String, required: true },
...
daycareSchema.index({ sukunimi_lapsi: 1, syntymaaika: 1 }, { background: true })

export default mongoose.model("DayCareForm", daycareSchema)
